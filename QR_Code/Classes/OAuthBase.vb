...
' This code is an translation of Eran Sandlers C# class OAuthBase in Visual Basic
' by Simon A. Frank (http://www.frank-it-beratung.com)

' Original Sourcecode in C#
' http://oauth.googlecode.com/svn/code/csharp/OAuthBase.cs

' Erans Homepage: http://eran.sandler.co.il/

' Details (in German language only) see:
' http://frank-it-beratung.com/2010/11/11/twitter-api-mit-oauth-und-visual-basic/
...
Public Class OAuthBase
    ...
    Public Function GenerateSignatureBase(ByVal url As Uri, ByVal consumerKey As String, ByVal token As String, ByVal tokenSecret As String, ByVal httpMethod As String, ByVal timeStamp As String,
    ...
    ''' <param name="httpMethod">The http method used. Must be a valid HTTP method verb (POST,GET,PUT, etc)</param>
    ''' <returns>A base64 string of the hash value</returns>
    Public Function GenerateSignature(ByVal url As Uri, ByVal consumerKey As String, ByVal consumerSecret As String, ByVal token As String, ByVal tokenSecret As String, ByVal httpMethod As String,
    ...
    Public Function GenerateSignature(ByVal url As Uri, ByVal consumerKey As String, ByVal consumerSecret As String, ByVal token As String, ByVal tokenSecret As String, ByVal httpMethod As String,
     ByVal timeStamp As String, ByVal nonce As String, ByVal signatureType As SignatureTypes, ByRef normalizedUrl As String, ByRef normalizedRequestParameters As String) As String
        ...
        Select Case signatureType
            ' Sowieso nicht notwendig - spart das etwas aufwendige Einbinden von HttpUtility 
            'Case SignatureTypes.PLAINTEXT
            '    Return HttpUtility.UrlEncode(String.Format("{0}&{1}", consumerSecret, tokenSecret))
            Case SignatureTypes.HMACSHA1
                Dim signatureBase As String = GenerateSignatureBase(url, consumerKey, token, tokenSecret, httpMethod, timeStamp,
